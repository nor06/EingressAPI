...
-- psql not recognized
-- add a path in system variables where the bin in postgresql found in environmental variables
...
-- make it available in local network where other device can access it
-- windows firewall
-- Advanced Settings → Inbound Rules → New Rule
-- Allow TCP port 3000.
-- Choose:
-- Port → TCP → Specific port: 3000
-- Allow the connection
-- Apply to Private networks
-- Name it something like NestJS Local Access

-- run
-- ng serve --host 0.0.0.0 --port 4200

-- it can access it from other device using this..
-- http://<your-ip>:4200
